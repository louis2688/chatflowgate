...
export const metadata = { title: "Contact - ChatLayer" };
    ...
    <MarketingShell title="Contact" subtitle="We would love to hear from you.">
      <div className="grid gap-4 sm:grid-cols-3">
        <div className={row}>
          ...
          <a href="mailto:support@chatlayer.io" className={`${a} mt-2 inline-block text-sm`}>support@chatlayer.io</a>
        </div>
        <div className={row}>
          ...
          <a href="mailto:hello@chatlayer.io" className={`${a} mt-2 inline-block text-sm`}>hello@chatlayer.io</a>
        </div>
        <div className={row}>
          ...
          <a href="mailto:privacy@chatlayer.io" className={`${a} mt-2 inline-block text-sm`}>privacy@chatlayer.io</a>
        </div>
      </div>
      <p className="text-sm text-neutral-500">Replace these with your real addresses once the ChatLayer.io mailboxes are set up.</p>
    </MarketingShell>
  );
}