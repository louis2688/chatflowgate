...
export default function TermsPage() {
  return (
    <MarketingShell title="Terms of Service" subtitle="The basics of using ChatFlowGate.">
      <p>By creating a workspace or using ChatFlowGate, you agree to these terms.</p>

      <h2 className={h2}>The service</h2>
      <p>
        ChatFlowGate is a secure gateway and widget for n8n Chat workflows. You bring your own n8n instance and webhooks; we proxy, secure, and
      ...
      <p>
        To the extent permitted by law, ChatFlowGate is not liable for indirect or consequential damages, or for the acts of your workflows or
      ...
      <p>
        ...
        <a href="mailto:hello@chatflowgate.com" className="text-[#4a90e2] hover:underline">hello@chatflowgate.com</a>.
      </p>
